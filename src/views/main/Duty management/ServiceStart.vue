  ...
  <div class="fill_height mwidth dflex direction-column">
    <el-card>
      ...
      <el-form :model="formInline" label-width="100px" :inline="true" class="dflex">
        ...
        <el-form-item class="flex1">
          ...
          <el-button @click="onSubmit1" plain type="primary">创建任务</el-button>
        </el-form-item>
      </el-form>
      ...
      <el-dialog :visible.sync='dialogVisible' center width="25%">
        <el-form :model="form" label-width="130px">
          ...
          <el-form-item label="勤务时间：">
            <el-date-picker v-model="form.DutyTime" style="width:100%" type="datetime" placeholder="选择日期时间">
            </el-date-picker>
          </el-form-item>
          <el-form-item label="勤务任务：">
            <el-input type="textarea" v-model="form.DutyTasks" :autosize="{ minRows: 2, maxRows: 4 }"></el-input>
          </el-form-item>
          <el-form-item label="执勤民警：">
            <el-input v-model="form.PolicemanOnDuty"></el-input>
          </el-form-item>
          <el-form-item label="所属检查站：">
            <el-select v-model="form.OwnedCheckpoint" style="width:100%" placeholder="请选择检查站">
    ...
    <el-card class="mt-10 pb-30 flex1 posi-rel over-h" body-style="height: 100%">
      <el-table :data="tableDate" fit border style="width: 100%" class="flex1" height="100%">
        ...
        <el-table-column prop="CaptainOnDuty" label="执勤队长" align="center" min-width="90px">
        </el-table-column>
        <el-table-column prop="DutyMember" :formatter="dutyList" label="值班队员" align="center" min-width="90px">
        </el-table-column>
        <el-table-column prop="PoliceForce" :formatter="dutyUnit" label="警务力量" align="center" min-width="90px">
        </el-table-column>
        <el-table-column prop="VehicleLocation" label="车辆位置" align="center" min-width="90px">
        </el-table-column>
        <el-table-column prop="DutyReport" label="勤务上报" align="center" min-width="90px">
        </el-table-column>
        <el-table-column prop="DutyTime" label="勤务时间" align="center" min-width="90px">
        </el-table-column>
        <el-table-column prop="DutyTasks" label="勤务任务" align="center" min-width="90px">
        </el-table-column>
        <el-table-column prop="PolicemanOnDuty" label="执勤民警" align="center" min-width="90px">
        </el-table-column>
        <el-table-column prop="OwnedCheckpoint" label="所属检查站" align="center" min-width="90px">
        </el-table-column>
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            ...
            <el-button @click="handleDetails1(scope.$index, scope.row)" type="primary" size="mini">
              删除
            </el-button>
          </template>
        </el-table-column>
      ...
      <el-dialog :visible.sync='dialogVisible1' title="编辑" width="25%">
        <el-form :model="form1" label-width="130px">
          ...
          <el-form-item label="勤务时间：">
            <el-date-picker v-model="form1.DutyTime" style="width:100%" type="datetime" placeholder="选择日期时间">
            </el-date-picker>
          </el-form-item>
          <el-form-item label="勤务任务：">
            <el-input type="textarea" v-model="form1.DutyTasks" :autosize="{ minRows: 2, maxRows: 4 }"></el-input>
          </el-form-item>
          <el-form-item label="执勤民警：">
            <el-input v-model="form1.PolicemanOnDuty"></el-input>
          </el-form-item>
          <el-form-item label="所属检查站：">
            <el-select v-model="form1.OwnedCheckpoint" style="width:100%" placeholder="请选择检查站">
              <el-option label="部门一" value="bumengyi"></el-option>
              <el-option label="部门二" value="bumenger"></el-option>
            </el-select>
          </el-form-item>
