<template>
  ...
  <div class="fill_height mwidth dflex direction-column">
    <el-card>
      ...
      <el-form :model="formInline" label-width="100px" :inline="true" class="dflex">
        ...
        <el-form-item label="勤务时间：" class="flex1">
          <el-date-picker v-model="formInline.DutyTime" type="datetime" placeholder="选择日期时间">
          </el-date-picker>
        </el-form-item>
        <el-form-item label="所属检查站：" class="flex1">
          <el-select v-model="formInline.OwnedCheckpoint" placeholder="请选择检查站" class="w250">
      ...
      <el-dialog :visible.sync='dialogVisible' title="上报" width="45%">
        <el-form :model="form" :inline="true" label-width="150px">
          ...
          <el-form-item label="查获时间：">
            <el-date-picker class="w200" v-model="form.SeizedTime" type="datetime" placeholder="选择日期时间">
            </el-date-picker>
          </el-form-item>
          ...
          <el-form-item label="数量：">
            <el-input v-model.number="form.NumberSeized" class="w200" type="number" :maxlength="3" onkeyup="value=value.replace(/[^\d]/g,'')" onblur="value=value.replace(/[^\d]/g,'')" :min="1"></el-input>
          </el-form-item>
          <el-form-item label="查获描述：">
            <el-input class="w200" type="textarea" v-model="form.SeizedDescription" :autosize="{ minRows: 2, maxRows: 4 }"></el-input>
          </el-form-item>
        </el-form>
    ...
    <el-card class="mt-10 pb-30 flex1 posi-rel over-h" body-style="height: 100%">
      <el-table :data="tableDate" fit border style="width: 100%" class="flex1" height="100%">
        ...
        <el-table-column prop="SiteName" label="站点名称" align="center" min-width="90px">
        </el-table-column>
        <el-table-column prop="SeizedTime" label="查获时间" align="center" min-width="90px">
        </el-table-column>
        <el-table-column prop="PoliceSeized" label="查获民警" align="center" min-width="90px">
        </el-table-column>
        <el-table-column prop="BeSeized" label="被查获人员姓名/物品名称" align="center" min-width="90px">
        </el-table-column>
        <el-table-column prop="BeSeizedID" label="被查获人证件号码" align="center" min-width="90px">
        </el-table-column>
        <el-table-column prop="SeizedDescription" label="查获描述" align="center" min-width="90px">
        </el-table-column>
        <el-table-column prop="PolicemanOnDuty" label="执勤民警" align="center" min-width="90px">
        </el-table-column>
      ...
      <el-dialog :visible.sync='dialogVisible2' title="详情" width="45%">
        <el-form :model="form" :inline="true" label-width="150px">
          <el-form-item label="所属站点：">
            <el-input class="w200" v-model="form.OwnedSite" :disabled="true"></el-input>
          </el-form-item>
          <el-form-item label="查获时间：">
            <el-date-picker class="w200" :disabled="true" v-model="form.SeizedTime" type="datetime" placeholder="选择日期时间">
            </el-date-picker>
          </el-form-item>
          <el-form-item label="查获民警：">
            <el-input class="w200" :disabled="true" v-model="form.PoliceSeized"></el-input>
          </el-form-item>
          <el-form-item label="执勤民警：">
            <el-input class="w200" :disabled="true" v-model="form.PolicemanOnDuty"></el-input>
          </el-form-item>
          <el-form-item label="被查获人员姓名：">
            <el-input class="w200" :disabled="true" v-model="form.SeizedPersonnel"></el-input>
          </el-form-item>
          <el-form-item label="户籍：">
            <el-input class="w200" :disabled="true" v-model="form.Domicile"></el-input>
          </el-form-item>
          <el-form-item label="证件号码：">
            <el-input class="w200" :disabled="true" v-model="form.IDNumber"></el-input>
          </el-form-item>
          <el-form-item label="被查获危险物品：">
            <el-input class="w200" :disabled="true" v-model="form.dangerousItem"></el-input>
          </el-form-item>
          <el-form-item label="数量：">
            <el-input v-model.number="form.NumberSeized" :disabled="true" class="w200" type="number" :maxlength="3" onkeyup="value=value.replace(/[^\d]/g,'')" onblur="value=value.replace(/[^\d]/g,'')" :min="1"></el-input>
          </el-form-item>
          <el-form-item label="查获描述：">
            <el-input class="w200" :disabled="true" type="textarea" v-model="form.SeizedDescription" :autosize="{ minRows: 2, maxRows: 4 }"></el-input>
          </el-form-item>
        </el-form>
        <span slot="footer" class="dialog-footer">
