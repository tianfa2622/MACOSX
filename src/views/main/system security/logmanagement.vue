  ...
  <div class="fill_height mwidth dflex direction-column">
    <el-card>
      ...
      <el-form :model="formInline" :inline="true" class="ml-30">
        ...
        <el-form-item>
          <el-button type="primary" @click="onSubmit" class="w150 ml-30">查询</el-button>
        </el-form-item>
      </el-form>
    </el-card>
    ...
    <el-card class="mt-10 pb-30 flex1 posi-rel over-h" body-style="height: 100%">
      <el-table :data="tableDate" fit border style="width: 100%" class="flex1" height="100%">
        ...
        <el-table-column prop="OperatingContent" label="操作内容" align="center">
        </el-table-column>
        <el-table-column prop="OperationOf" label="操作人" align="center">
        </el-table-column>
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            <el-button @click="handleDetails(scope.$index, scope.row)" type="primary" style="width:40%">
              详情
            </el-button>
          </template>
        </el-table-column>
      ...
      <!-- 详情 -->
      <el-dialog :visible.sync='dialogVisible' title="详情" width="40%" style="height:100%">
        <el-table :data="tableDate1" fit border style="width: 100%">
          ...
          <el-table-column prop="ValueBeforeModification" label="修改前的值" align="center">
          </el-table-column>
          <el-table-column prop="ModifiedValue" label="修改后的值" align="center">
          </el-table-column>
        </el-table>
      </el-dialog>
      <!-- 分页 -->
