  ...
  <div class="fill_height mwidth dflex direction-column">
        ...
        <el-row type="flex" justify="space-around">
          <el-col :span="5">
            <el-form-item label="警备装备名称：">
              <el-input v-model="formInline.equipmentName" class="w250"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="5">
    ...
    <el-card class="mt-10 pb-30 flex1 posi-rel over-h" body-style="height: 100%">
      <el-table :data="tableDate" fit border style="width: 100%" class="flex1" height="100%">
        ...
        <el-table-column prop="equipmentName" label="警备装备名称" align="center">
        </el-table-column>
        <el-table-column prop="equipmentNumber" label="数量" align="center">
        </el-table-column>
        <el-table-column prop="CheckpointCategory" label="公安检查站" align="center">
        </el-table-column>
      ...
      <el-dialog :visible.sync='dialogVisible' title="编辑" width="25%">
        <el-form :model="form" label-width="130px">
          ...
          <el-form-item label="数量：">
            <el-input v-model.number="form.contactNumber" type="number" maxlength="3" onkeyup="value=value.replace(/[^\d]/g,'')" onblur="value=value.replace(/[^\d]/g,'')" :min="1"></el-input>
          </el-form-item>
          <el-form-item label="公安检查站：">
